...
public class ShellyCoapJSon {
    ...
    protected static class CoIoT_SensorTypeAdapter extends TypeAdapter {
        @Override
        ...
        @Override
        public void write(final JsonWriter out, final Object o) throws IOException {
            CoIoT_GenericSensorList sensors = (CoIoT_GenericSensorList) o;
            out.beginObject();
            if (sensors != null) {
